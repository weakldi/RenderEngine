...
public class Keyboard {
	...
	private static Queue<Character> chars = new LinkedList<>();
	...
	public static Boolean isKeyPressed(int key){
		return keys.get(Integer.valueOf(key));
	}
	static boolean jtLetter;
	public static void update(){
		...
		if(org.lwjgl.input.Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) && !org.lwjgl.input.Keyboard.isKeyDown(Keyboard.KEY_RSHIFT)){
		 ...
		 while (org.lwjgl.input.Keyboard.next()) {
	            if (org.lwjgl.input.Keyboard.getEventKeyState() && !jtLetter) {
...
//		while(org.lwjgl.input.Keyboard.next()){
//			if(org.lwjgl.input.Keyboard.getEventKeyState()==false){
////				keysRelesed.add(org.lwjgl.input.Keyboard.getEventKey());
//				chars.add(Character.valueOf(org.lwjgl.input.Keyboard.getEventCharacter()));
//				System.out.println((int)chars.peek());
//			}
//		}
		for (Integer key : keySet) {
			keys.put(key, org.lwjgl.input.Keyboard.isKeyDown(key));
		}
		if(chars.size()>100){
			chars.remove(0);
